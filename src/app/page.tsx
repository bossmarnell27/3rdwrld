    ...
    <>
      ...
      <section className="px-6 py-20 md:px-16 max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-12">
          <h2 className="fx-clean text-sm md:text-base uppercase tracking-[0.3em] text-[#888]">
            Featured
          </h2>
          <Link
            href="/explore"
            ...
            >
              <div className="relative aspect-[4/3] bg-[#111] overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="fx-pixel text-sm md:text-base uppercase tracking-[0.2em] text-[#ccc] border border-[#333] px-3 py-1.5">
                    {item.tag}
                  </span>
                </div>
              </div>
      ...
      {/* Compact studio CTA above the footer — restrained, not dominant. */}
      <section className="border-t border-[#222] px-6 py-10 md:px-16">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="fx-pixel text-base md:text-lg tracking-tight text-[#ddd]">
